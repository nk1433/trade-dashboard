      ...
      <Box sx={{ maxWidth: 1400, margin: 'auto', p: 3 }}>
        ...
        <Paper sx={{ p: 3, bgcolor: '#fff', borderRadius: 2, borderLeft: '4px solid #000', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          ...
          <Box component="ul" sx={{ m: 0, pl: 2, '& li': { mb: 1, color: '#444', lineHeight: 1.6 } }}>
            ...
            <li>A well defined setup will tell you: what kind of stock or etf or instrument to buy, why, where to buy it, how much to buy, where to put stops, where to exit, what kind of profit can you expect with this kind of setup, how many trades can you expect with this setup, what overall market conditions favor this setup, When should you not trade this setup, when should you risk less or more.</li>
          </Box>
        </Paper>
